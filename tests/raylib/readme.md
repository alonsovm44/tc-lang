...
# you could also do: 
tigc ray.tc -c game.exe -- -Isrc -IC:/raylib/raylib/src -LC:/raylib/raylib/build/raylib  -lraylib -lws2_32 -lwinhttp -lopengl32 -lgdi32 -lwinmm # but this method is broken for some reason
```
Run demo with
```bash
./game.exe
